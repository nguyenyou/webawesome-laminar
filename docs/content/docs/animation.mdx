...
```scala example id="animation-overview" h-[160px]
...
```scala preview id="animations-easings" h-[375px]
...
```scala preview id="animation-scroll" h-[150px]
