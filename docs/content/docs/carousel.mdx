...
```scala preview id="vertical-carousel" h-[420px] center
Carousel(
  _.pagination := true,
...
```scala preview id="carousel-thumbnails" h-[500px] center
