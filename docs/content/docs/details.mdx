...
```scala examples vertical h-[320px] start
Details(
  _.summary := "Start",
...
```scala examples vertical start h-[400px]
Details(
...
```scala examples vertical start h-[320px]
Details(
  _.name    := "group-1",
  _.summary := "Section 1",
  _.open    := true
