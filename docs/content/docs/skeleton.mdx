...
```scala preview id="skeleton-overview"
div(
...
```scala preview id="skeleton-paragraphs"
div(
...
```scala preview id="skeleton-avatars"
div(
...
```scala preview id="skeleton-shapes"
div(
  cls := "skeleton-shapes",
