...
```scala preview id="skeleton-overview" h-[240px] stretch
div(
  cls := "skeleton-overview",
  div(
    cls := "skeleton-header",
    Skeleton(_.effect.sheen)(height.px(48), width.px(48)),
    Skeleton(_.effect.sheen)(height.px(16))
  ),
  Skeleton(_.effect.sheen)(height.px(16)),
  Skeleton(_.effect.sheen)(height.px(16)),
  Skeleton(_.effect.sheen)(height.px(16))
...
```scala examples vertical h-[160px] stretch
Skeleton(_.effect.none)(height.px(16))
Skeleton(_.effect.sheen)(height.px(16))
Skeleton(_.effect.pulse)(height.px(16))
```
...
```scala preview id="skeleton-paragraphs" h-[160px] stretch
div(
  cls := "skeleton-paragraphs",
  Skeleton()(height.px(16)),
  Skeleton()(height.px(16)),
  Skeleton()(height.px(16)),
  Skeleton()(height.px(16))
)
...
```scala preview id="skeleton-avatars" h-[100px] stretch
div(
  cls := "skeleton-avatars",
  Skeleton()(height.px(48), width.px(48)),
  Skeleton()(height.px(48), width.px(48)),
  Skeleton()(height.px(48), width.px(48))
)
```
...
```scala preview id="skeleton-shapes" h-[100px] stretch
div(
  cls := "skeleton-shapes",
  Skeleton()(cls := "square", height.px(48), width.px(48)),
  Skeleton()(cls := "circle", height.px(48), width.px(48)),
  Skeleton()(cls := "triangle", height.px(48), width.px(48)),
  Skeleton()(cls := "cross", height.px(48), width.px(48)),
  Skeleton()(cls := "comment", height.px(48), width.px(48))
)
```
