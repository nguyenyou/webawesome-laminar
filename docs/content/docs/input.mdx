...
```scala examples vertical h-[200px] stretch
Input(
  _.placeholder := "Small",
  _.size.small
)()
...
```scala example id="label-on-left" h-[380px] stretch
cls := "label-on-left",
Input(
  _.label := "Name",
