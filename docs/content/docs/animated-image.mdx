...
```css forId="animated-image-custom-control-box"
...
```scala preview id="animated-image-custom-control-box" h-[500px]
AnimatedImage(
  _.src := "https://shoelace.style/assets/images/walk.gif",
  _.alt := "Animation of untied shoes walking on pavement"
)(
