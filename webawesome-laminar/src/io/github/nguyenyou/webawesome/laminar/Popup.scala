...
object Popup extends WebComponent("wa-popup") {
  ...
  lazy val arrowPlacement: CommonKeys.PopupArrowPlacement.type = CommonKeys.PopupArrowPlacement
  ...
  lazy val flipFallbackStrategy: CommonKeys.PopupFlipFallbackStrategy.type = CommonKeys.PopupFlipFallbackStrategy
  ...
  lazy val autoSize: CommonKeys.PopupAutoSize.type = CommonKeys.PopupAutoSize

  /** Syncs the popup's width or height to that of the anchor element. Valid values: "width", "height", "both". */
  lazy val sync: CommonKeys.PopupSync.type = CommonKeys.PopupSync
  ...
  @js.native trait WaPopupComponent extends js.Object {
