...
object distReactPageMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@awesome.me/webawesome/dist/react/page", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distReactPageMod.foo` */
